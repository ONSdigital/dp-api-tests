		...
		Convey("When a root hierarchy node is requested", func() {
			...
			Convey("Then a root hierarchy node is return as a response", func() {
				...
				codeLink.Value("href").String().
					Equal(cfg.HierarchyAPIURL + "http://localhost:22400/code-lists/e44de4c4-d39e-4e2f-942b-3ca10584d078/code/cpi1dim1A0")
				...
				firstCodeLink.Value("href").String().
					Equal("http://localhost:22400/code-lists/e44de4c4-d39e-4e2f-942b-3ca10584d078/code/cpi1dim1T10000")
